...
class ReadAiNextWordModelData(QThread):
    ...
    def __init__(self, parent):
        ...
        self.AiCompletion = AiCompletion
        self.parent = parent

    task_finished = Signal()

    def run(self):
        self.parent.ai_next_word_prid = self.AiCompletion()
...
def make_thread_for_train_model(self, n_prev_words, epoch_num):
    ...
    from functionality.thread_workers.retrainNextWordModelWorker import RetrainNextWordModelWorker
...
def make_thread_for_read_mode(self, text):
    from functionality.thread_workers.readLoadWorker import ReadLoadWorker
...
def make_thread_for_ai_task(self, func):
    from functionality.thread_workers.AITaskWorker import AITaskWorker
